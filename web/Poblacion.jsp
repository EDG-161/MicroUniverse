            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Informes <h5>Si tienes problemas al visualizar prueba cambiar de navegador</h5>
                                </h4>
                                <p class="category"></p>
                            </div>
                                            ...
                                            for (Informe infT : infor) {
                                                ...
                                                <tr>
                                                    <td><a href="">Informe <%out.print(infT.getId_inf());%></a></td>
                                                        ...
                                                        <td><a href="http://<%=new direccion().dir%>:8001/MicroUniverse_Informe/bd/informe_gener.php?id=<%out.print(tm.getId_inf());%>&t=<%out.print(tm.getText());%>&tm=<%out.print(tm.getTm());%>&ph=<%out.print(tm.getPh());%>&aw=<%out.print(tm.getAw());%>&pob=<%out.print(tm.getPob());%>&f=<%out.print(tm.getDate());%>">Ver</a>/<a href="Eliminar?ide=<%out.print(infT.getId_inf()+123);%>&tipo=Informe">Eliminar</a> </td>
                                                </tr>
                                        <%
                                            }
                                        }else{
                                ...
                                <form action="GCrecimiento" method="POST">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody  id="regH">
                                                    ...
                                                    <div class="conteiner">
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                ...
                                                                <input type="hidden" readonly name="num" id="ncsc" value="3">
                                         ...
                                         <tr>
                                             <td><button type="button" id="plusR" class="btn btn-fill btn-success" style="font-size: 25px;">+</button>
                                                <button type="button" id="plusR2" class="btn btn-fill btn-success" style="font-size: 25px;">-</button></td>
                                                <td align="center"> <input type="submit" class="btn" value="Guardar crecimiento"> </td>
                                            </tr>
                                    </table>
                                </form>
                            </div>
	...
	<script src="Assets/js/demo.js"></script>
        <script>
            ...
            $('#plusR').click(function(e){
                cs++;
                var cont = document.getElementById('regH').innerHTML;
                var nc ='<tr><td><div class="conteiner"><div class="row">';
                nc = nc+'<div class="col-md-8">'
                nc = nc+'<input type="number" required name="'+cs+'h" pattern="[0-9]" class="form-control">'
                nc = nc+'</div></div></div> </td><td><div class="conteiner"><div class="row">'
                nc = nc+'<div class="col-md-6"><input type="number" required name="'+cs+'p" step="any" class="form-control">'
                nc = nc+'</div><div class="col-md-6">log UFC/g</div></div></div></td></tr>';
                var cr = cont + nc;
                document.getElementById('regH').innerHTML = cr;
                cont = cr;
                $('#ncsc').val(cs);
                ina= false;
            });
            $('#plusR2').click(function(e){
                if (!ina&&cs>3) {
                    var cont = document.getElementById('regH').innerHTML;
                    var cr = cont.substring(0,(cont.length-374));
                    document.getElementById('regH').innerHTML = cr;
                    cont = cr;
                    cs--;
                }
