 ...
 * @author Eduardo
 */
public class EliminarInforme extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Informe p = Conexion.getInformeById(id);
            Conexion.eliminarInforme(id);
            
            try{
            response.sendRedirect("Proyectos.jsp?error=2&text=Informe eliminada");
